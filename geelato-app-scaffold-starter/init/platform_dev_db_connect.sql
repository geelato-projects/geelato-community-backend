...
-- ----------------------------
-- Table structure for platform_dev_db_connect
-- ----------------------------
DROP TABLE IF EXISTS `platform_dev_db_connect`;
CREATE TABLE `platform_dev_db_connect`  (
  ...
  `db_schema` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '数据库schema',
  `db_hostname_ip` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `db_name` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `db_type` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '数据库类型',
  `db_user_name` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '用户名',
  `db_connect_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `db_port` int NULL DEFAULT 0,
  `enable_status` tinyint(1) NOT NULL DEFAULT 0,
  `db_password` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '密码',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '数据库连接信息' ROW_FORMAT = Dynamic;
