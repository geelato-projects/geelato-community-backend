...
-- ----------------------------
-- Table structure for platform_role_r_user
-- ----------------------------
DROP TABLE IF EXISTS `platform_role_r_user`;
CREATE TABLE `platform_role_r_user`  (
...
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '角色用户关系表' ROW_FORMAT = Dynamic;
