...
-- ----------------------------
-- Table structure for platform_user_r_permission
-- ----------------------------
DROP TABLE IF EXISTS `platform_user_r_permission`;
CREATE TABLE `platform_user_r_permission`  (
