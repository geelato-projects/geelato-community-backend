...
public class MetaRelf {
    ...
    public static TableMeta getTableMeta(Map map) {
        ...
        String title = StringUtils.hasText(tableMeta.getTitle()) ? tableMeta.getTitle() : (cn.geelato.core.util.StringUtils.isEmpty(tableMeta.getTableName()) ? tableMeta.getEntityName() : tableMeta.getTableName());
        tableMeta.setId(id);
