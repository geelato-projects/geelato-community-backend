-- geelato-mail mail_contact_group 表（提取自 fms db/migration/V129__create_mail_p2_contact_tables.sql，catalog 逻辑分组 mail，表名不加库前缀）
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '邮件联系人分组表' ROW_FORMAT = Dynamic;
