-- geelato-mail mail_label 表（提取自 fms db/migration/V126__create_mail_p1_tables.sql，catalog 逻辑分组 mail，表名不加库前缀）
...
CREATE TABLE IF NOT EXISTS `mail_label` (
  ...
  `account_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '所属邮箱账户ID（NULL=用户级共享标签）',
  `name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '标签名称',
  `color` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '#165dff' COMMENT '标签颜色（HEX）',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '邮件用户标签表' ROW_FORMAT = Dynamic;
