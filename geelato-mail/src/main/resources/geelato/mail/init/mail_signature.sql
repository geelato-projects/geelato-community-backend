-- geelato-mail mail_signature 表（提取自 fms db/migration/V126__create_mail_p1_tables.sql，catalog 逻辑分组 mail，表名不加库前缀）
...
CREATE TABLE IF NOT EXISTS `mail_signature` (
  ...
  `account_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '所属邮箱账户ID（NULL=用户级共享签名）',
  `name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '签名名称',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '签名内容（HTML）',
  `is_default` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否默认签名',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '邮件个性签名表' ROW_FORMAT = Dynamic;
