...
public class ExcelWriter {
    ...
    private void copyCell(HSSFCell cell, int addCellCount) {
        ...
        for (int i = 0; i < addCellCount; i++) {
            HSSFCell newCell = cell.getRow().createCell(cell.getColumnIndex() + 1 + i);
            newCell.setCellStyle(cell.getCellStyle());
        }
    }

    private void copyRow(HSSFCell cell, int addRowCount) {
        HSSFSheet sheet = cell.getSheet();
