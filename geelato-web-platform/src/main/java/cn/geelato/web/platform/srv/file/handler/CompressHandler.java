...
import cn.geelato.web.platform.srv.file.service.CompressService;
...
public class CompressHandler extends AttachmentHandler<Compress> {
     ...
     */
    @Override
    public Compress create(Compress attachment) {
        return compressService.createModel(attachment);
    }
    ...
    @Override
    public Compress upload(File file, String name, String path, ThumbnailParam param) throws IOException {
        // 保存文件到磁盘
