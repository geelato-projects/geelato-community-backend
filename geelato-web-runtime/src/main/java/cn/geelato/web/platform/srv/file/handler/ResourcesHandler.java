package cn.geelato.web.platform.srv.file.handler;
...
import cn.geelato.web.platform.srv.file.param.ThumbnailParam;
import cn.geelato.web.platform.srv.file.param.ThumbnailResolution;
import cn.geelato.web.platform.srv.file.service.ResourcesService;
...
public class ResourcesHandler extends AttachmentHandler<Resources> {
     ...
     */
    @Override
    public Resources create(Resources attachment) {
        return resourcesService.createModel(attachment);
    }
    ...
    @Override
    public Resources upload(File file, String name, String path, ThumbnailParam param) throws IOException {
        // 保存文件到磁盘
