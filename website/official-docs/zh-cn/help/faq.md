...
两种标准方式（见 [快速开始](../guide/quick-start.md)）：
...
详见 [脚手架快速启动指南](../guide/app-scaffold-starter-project-guide.md)、[启动过程](../reference/startup-process.md)。
...
详见 [插件机制概览](../plugin-mechanism/overview.md)、[插件加载、启停与卸载](../plugin-mechanism/lifecycle.md)。
...
详见 [ORM / 数据源扩展](../orm/datasource-extension.md)。
